# meet-assist — Architecture v3

v2 | march 9, 2026, 2:10pm MST
...
`DEEPGRAM_API_KEY` loaded from environment via `~/.zkeys` → `~/.zshrc`. Never hardcoded.
...
P5      Live dry run — test before Trajan call Mar 13 2026
```
